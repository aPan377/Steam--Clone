...
const Navbar = () => {
  return (
    <div className="bg-[#171a21]">
      <div className="flex items-center max-w-[90vw] mx-auto relative">
        {/* Left */}
        ...
        <div className="absolute text-white  right-10 top-0 text-[12px] lg:flex  items-center mt-2 hidden">
          <div className="flex items-center bg-[#5c7e10] hover:bg-[#48640b] duration-200 px-2 py-1 rounded-[0.3rem] cursor-pointer">
            <ImDownload className="mr-2" />
            <p className=" ">Download App</p>
          </div>
          <div className=" ml-4 bg-white hover:bg-inherit px-2 py-[2px] rounded-[0.5rem] group duration-500 ease-out cursor-pointer">
            <p className="text-[#5c7e10] font-semibold group-hover:text-white duration-300 ease-out">
              Sign in
            </p>
          </div>
